...
output:
  html_document:
      ...
      theme: paper
      code_folding: hide
bibliography: input/bib/Entrega.bib
link-citations: yes
---
...
load("../Ciencia abierta/input/data/original/ELSOC_W04_v2.01_R(1).RData")
